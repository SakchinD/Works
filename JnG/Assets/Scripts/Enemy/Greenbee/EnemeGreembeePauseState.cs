...
public class EnemeGreembeePauseState : EnemyBaseState
{ 
    public override void EnterState(Enemy_Fsm enemy)
    {
        (enemy as EnemyGreenbee_Fsm).animator.speed = 0;
    }
    ...
    public override void Update(Enemy_Fsm enemy)
    {
        ...
        {
            (enemy as EnemyGreenbee_Fsm).PreviosState();
            (enemy as EnemyGreenbee_Fsm).animator.speed = 1;
        }
    }
}